...
test("URL format test", function() {
    equals(KE.format.getUrl(KE.$("test01").value, "absolute"), '/ke34/images/xxx.gif');
    equals(KE.format.getUrl(KE.$("test01").value, "relative"), './../images/xxx.gif');
    equals(KE.format.getUrl(KE.$("test01").value, "domain"), 'http://localhost/ke34/images/xxx.gif');
    ...
    equals(KE.format.getUrl(KE.$("test03").value, "absolute"), '/ke34/images/xxx.gif');
    equals(KE.format.getUrl(KE.$("test03").value, "relative"), './../images/xxx.gif');
    equals(KE.format.getUrl(KE.$("test03").value, "domain"), 'http://localhost/ke34/images/xxx.gif');
    equals(KE.format.getUrl(KE.$("test03").value), '/ke34/images/xxx.gif');

    equals(KE.format.getUrl(KE.$("test04").value, "absolute"), '/ke34/images/xxx.gif');
    equals(KE.format.getUrl(KE.$("test04").value, "relative"), './../images/xxx.gif');
    equals(KE.format.getUrl(KE.$("test04").value, "domain"), 'http://localhost/ke34/images/xxx.gif');
    equals(KE.format.getUrl(KE.$("test04").value), 'http://localhost/ke34/images/xxx.gif');
...
test("HTML format test", function() {
    ...
    equals(KE.format.getHtml(KE.$("test12").innerHTML), '123<div style="color:#ff0000;background-color:#00ff00;font-size:18px;font-weight:bold;" class="spanclass">test</div>123');
    equals(KE.format.getHtml(KE.$("test12").innerHTML, {span:[".color"]}), '123test123');
    equals(KE.format.getHtml(KE.$("test12").innerHTML, {div:[".font-size", "class"]}), '123<div style="font-size:18px;" class="spanclass">test</div>123');
    equals(KE.format.getHtml(KE.$("test12").innerHTML, {div:[".color"]}), '123<div style="color:#ff0000;">test</div>123');
    equals(KE.format.getHtml(KE.$("test12").innerHTML, {div:[".color", ".font-weight"]}), '123<div style="color:#ff0000;font-weight:bold;">test</div>123');
    ...
    equals(KE.format.getHtml(KE.$("test14").innerHTML, null, "relative"), '<img border="0" src="./../plugins/emoticons/etc_01.gif" /> test ');

    equals(KE.format.getHtml(KE.$("test15").innerHTML, null, "absolute"), '<img border="0" src="http://www.kindsoft.net/images/logo_180_30.gif" /> test ');
