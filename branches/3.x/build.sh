...
java -jar yuicompressor-2.4.1.jar --type js --charset utf-8 -v ./src/kindeditor-core.js >> ./build/kindeditor.js
...
java -jar yuicompressor-2.4.1.jar --type js --charset utf-8 -v ./src/kindeditor-core.js >> ./build/kindeditor-mini.js
