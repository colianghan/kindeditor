...
KE.cmd = function(id) {
    ...
    this.splitNodeParent = function(parent, node, pos) {
        ...
        KE.util.trimNodes(leftFrag);
        KE.util.trimNodes(parent);
